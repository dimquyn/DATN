...
export default function TicketDetailScreen() {
  ...
  // Bấm "Xác nhận phản hồi": lưu thẳng xuống Firestore, không cần nhân viên
  // chọn hình thức liên hệ — khiếu nại tới từ kênh nào (ticket.channel) thì
  // xem như phản hồi đi qua đúng kênh đó, hiển thị lại cho nhân viên biết.
